...
const SecretaryDashboard: React.FC = () => {
  ...
  const handleAddStudent = (e: React.FormEvent) => {
    ...
    setSearchTerm(newUser.name); // Filter to the new student immediately
  ...
  const renderStudents = () => (
    <div className="space-y-6 animate-fade-in">
          ...
          <div className="max-h-[500px] overflow-y-auto space-y-2 pr-1">
            {students.map(student => (
              ...
              >
                ...
                <div className="text-xs text-gray-700 font-medium">Nasc: {student.birthDate ? new Date(student.birthDate).toLocaleDateString('pt-BR') : '-'}</div>
              </div>
            ))}
      ...
      {/* Add Student Modal (Existing code) */}
         ...
         <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6 animate-fade-in overflow-y-auto max-h-[90vh]">
                <div className="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
                    <h3 className="text-xl font-bold text-gray-900">Cadastrar Novo Aluno</h3>
                ...
                <form onSubmit={handleAddStudent} className="space-y-4">
                    {/* ... (Existing form logic) ... */}
                    {/* Simplified for brevity as logic didn't change, just ensuring context */}
                    ...
                    <div className="pt-4 flex justify-end gap-3">
                        ...
                        >
                            <UserPlus size={18} className="mr-2" /> Salvar Cadastro
                        </button>
                    </div>
                </form>
            </div>

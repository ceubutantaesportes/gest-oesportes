                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="w-full pl-10 pr-10 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white text-gray-900 font-medium"
...
const DashboardLayout: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentUser?.role) {
      ...
      default: return <div>Perfil não encontrado</div>;
    }
  };
        ...
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <button className="w-full text-left px-4 py-2 bg-blue-600 rounded-lg text-sm font-medium flex items-center">
              <LayoutDashboard size={16} className="mr-2" /> Painel
            </button>
            <button 
